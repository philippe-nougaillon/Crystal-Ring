...
class FacturesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create facture" do
    assert_difference('Facture.count') do
      post factures_url, params: { facture: { typefacture: @facture.typefacture, cible: @facture.cible, etat: @facture.etat, num_chrono: @facture.num_chrono, par: @facture.po, société: @facture.société } }
    end
  ...
  test "should update facture" do
    patch facture_url(@facture), params: { facture: { typefacture: @facture.typefacture, cible: @facture.cible, etat: @facture.etat, num_chrono: @facture.num_chrono, par: @facture.po, société: @facture.société } }
